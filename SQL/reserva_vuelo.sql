...
cod_reserva as 'Codigo de reserva', fecha_reserva as 'Fecha de reserva',monto_total,nro_asiento as 'Numero de asiento',
...
inner join aeropuerto ae on ae.cod_aeropuerto = dv.cod_aeropuerto_origen
inner join aeropuerto ao on ao.cod_aeropuerto = dv.cod_aeropuerto_destino
